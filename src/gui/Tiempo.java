...
import classes.TiempoConverter;
...
public class Tiempo extends javax.swing.JFrame {
    ...
    public Tiempo() {
        ...
        for(String elemento : TiempoConverter.Unidades){
    ...
    private void btn_convertirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_convertirActionPerformed
        try {
            ...
            TiempoConverter conversor = new TiempoConverter(unidadOrigen, unidadFinal);
