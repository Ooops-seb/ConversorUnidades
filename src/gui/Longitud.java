...
import classes.LongitudConverter;
...
public class Longitud extends javax.swing.JFrame {
    ...
    public Longitud() {
        ...
        for(String elemento : LongitudConverter.Unidades){
    ...
    private void btn_convertirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_convertirActionPerformed
        try {
            ...
            LongitudConverter conversor = new LongitudConverter(unidadOrigen, unidadFinal);
